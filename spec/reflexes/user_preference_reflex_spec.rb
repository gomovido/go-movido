...
RSpec.describe UserPreferenceReflex, type: :reflex do
  ...
  let(:reflex) { build_reflex(url: new_user_preference_url, connection: { current_user: user }, params: { user_preference: { arrival: Faker::Date.forward(days: 30), stay_duration: 11, country_id: country.id } }) }
