...
export default class extends Controller {
  ...
  connect() {
    ...
    if (document.querySelector(".chat-container")) {
      this.messageTarget.classList.add(
        "animate__animated",
        "animate__fadeInLeft",
        `animate__delay-${this.messageTarget.dataset.delay}s`
      );
    }
    if (document.querySelector(".coming-soon-banner")) {
      document
        .querySelector(".coming-soon-banner")
        .classList.add(
          "animate__animated",
          "animate__fadeInLeft",
          `animate__delay-${
            document.querySelector(".coming-soon-banner").dataset.delay
          }s`
        );
    }
    this.contentContainerTarget.classList.add(
      "animate__animated",
      "animate__fadeInLeft",
      `animate__delay-${this.contentContainerTarget.dataset.delay}s`
    );
  }

  afterReflex(e, r, s) {
    if (r !== "CartReflex#promocode") {
      this.connect();
    }
  }
  ...
  toggleSpinner(spinner, spinner_duration) {
    if (spinner) {
      spinner.classList.add(
        "animate__animated",
        "animate__fadeInLeft",
        `animate__delay-${spinner.dataset.delay}s`
      );
      setTimeout((e) => {
  ...
  checkPromoCode(e) {
    this.stimulate("CartReflex#promocode", e.target, {
      serializeForm: true,
    });
  }

  promocodeSuccess(e) {
    document.querySelector(".promocode").classList.add("is-valid");
    document.querySelector(".promocode").readOnly = true;
  }
}
