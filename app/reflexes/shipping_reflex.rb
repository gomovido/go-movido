  ...
  def create
    ...
    if @shipping.save
      ...
      if current_user.user_preference.pickup?
        ...
        morph '.flow-container', render(partial: "steps/checkout/checkout", locals: { order: @order, messages: [{ content: "Thanks #{current_user.first_name}, now please enter your payment details to finalize the order of your Starter Pack", delay: 0 }] })
      end
    else
