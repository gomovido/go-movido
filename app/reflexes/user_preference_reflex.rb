class UserPreferenceReflex < ApplicationReflex
  ...
  def create
    ...
    if @user_pref.save
      morph '.flow-container', render(partial: "steps/cart/cart", locals: { user_preference: @user_pref, message: { content: "Almost done! Please select the services you need - you can pick and choose across packs if you like", delay: 0 } })
    else
