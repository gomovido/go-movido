class UserPreferenceReflex < ApplicationReflex
  ...
  def create
    ...
    if @user_preference.save
      morph '.flow-container', render(partial: "steps/cart/new", locals: { order: current_user.current_draft_order || Order.new,user_preference: @user_preference, message: { content: "Almost done! Please select the services you need - you can pick and choose across packs if you like", delay: 0 } })
    else
