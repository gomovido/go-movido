module Forest
  class MobilesController < ForestLiana::SmartActionsController
    ...
    def create_offers_translations
      ...
      render json: {
        success: 'Translations are successfully implemented.',
        redirectTo: "/go-movido-admin/#{Rails.env.capitalize}/Movido/data/Mobile/index/record/Mobile/#{mobile.id}/has-many/Mobile-special_offer_translations"
      }
    end
  end
end
