class AddressesController < ApplicationController
  ...
  def subscription_params
    params.require(:subscription).permit(:delivery_address, :sim, :contact_phone, :algolia_country_code,
                                         billing_attributes: %i[address bic iban bank user_id], address_attributes: %i[id floor street building stairs door gate_code])
  end
